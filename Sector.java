...
public class Sector {
	...
	public Sector( int id,
			 @Size(min = 2, max = 10, message = "Sector name should be between 2 and 10 characters") String sectorName,
			 @Size(min = 2, max = 400, message = "Breif should be between 2 to 400 characters") String brief) {
		super();
		this.id = id;
